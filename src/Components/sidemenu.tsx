...
const Sidemenu = (props:any) => {
    ...
    <div className="popup-content">
      <h1 style={{color:"black"}} className="label">Fill Form to Download Brouchure</h1>
      
      <p><form action="/popup.php" name="brouchereform"  method="POST" id="frmdb">
             <div id="sucess1"></div>               
                <div className="inputGroup2">
                  <input className="input" placeholder="Your emailId" type="email" name="email" id="email1"/><br/>
                  <label >*Email</label>
                </div>
                <div className="inputGroup2">
                  <input className="input" type="number" placeholder="Your Phone Number" required name="mobile" id="mobile1"/><br/>
                  <label>*Mobile</label>
                </div>             
...
<a  className={nextstep} onClick={handelPopUp}>Download Brouchure</a>
  ...
  <div className={costone}>
    <div className="popup-content" style={{height:"180px"}}>
    <h1 style={{color:"black"}} className="label">Fill Form to Download cost sheet</h1>
      
     <form action="/popup.php"  method="POST" className="callRequest" id="frmps">
             <div id="sucess2"></div>      
                <div className="inputGroup2">
                  <input className="input" type="email" placeholder="Your Emailid" name="email" id="email2"/><br/>
                  <label>*Email</label>
                </div>
                <div className="inputGroup2">
                  <input className="input" type="number" required placeholder="Your Number" name="mobile" id="mobile2"/><br/>
                  <label>*Mobile</label>
                </div>             
                <div className="btn-group">
